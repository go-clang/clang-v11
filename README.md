...
[![PkgGoDev](https://pkg.go.dev/badge/github.com/go-clang/clang-v11)](https://pkg.go.dev/github.com/go-clang/clang-v11)
[![GitHub Workflow](https://img.shields.io/github/workflow/status/go-clang/clang-v11/Test/main?label=test&logo=github&style=flat-square)](https://github.com/go-clang/clang-v11/actions)

Native Go bindings for Clang v11 C API.

## Install/Update

```bash
CGO_LDFLAGS="-L`llvm-config --libdir`" \
  go install github.com/go-clang/clang-v11/...
```
